            ...
            <div className="after:mt-4 after:block after:h-1 after:w-full after:rounded-lg after:bg-gray-200">
                <ol className="grid grid-cols-3 text-sm font-medium text-gray-500">
                    <li className={cn(
                        ...
                        <span className="hidden sm:block">Passenger details </span>
                    ...
                    <li className={cn(
                        ...
                        <span className="hidden sm:block"> Payment information</span>
                    ...
                    <li className={cn(
                        ...
                        <span className="hidden sm:block"> Confirmed! </span>
